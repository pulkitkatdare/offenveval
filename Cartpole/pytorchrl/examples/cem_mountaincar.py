...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=128, help='critic learning rate')
    parser.add_argument('--episode_len', type=float, default=50, help='buffer size in replay buffer')
    parser.add_argument('--elite_frac', type=float, default=0.1, help='noide standard deviation')
    parser.add_argument('--noise_decay_const', type=float, default=1.0, help='noise standard deviation')
    parser.add_argument('--noise_ampl', type=float, default=1.0, help='noise standard deviation')
    parser.add_argument('--is_train', type=bool, default=True, help='train mode or test mode. Default is test mode')
    parser.add_argument('--actor_weights', type=str, default='cem_mountaincar', help='Filename of actor weights. Default is actor_cartpole')
