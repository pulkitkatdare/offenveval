from ReacherEnv.common.replaybuffer import ReplayBuffer
import numpy as np
...
def collect_data(simulation_env, deployment_env, episodes=1000, buffer_size=1000000, epsilon=0.7):
    ...
    actor_critic, obs_rms = \
                torch.load('ReacherEnv/expert/pytorch-a2c-ppo-acktr-gail/trained_models/ppo/ReacherBulletEnv-v0.pt',
                                map_location='cpu')
...
def save_model(D_P, D_Q, environment='GridWorld10x10'):
    save_folder = 'ReacherEnv/environmentdata/' + environment + '/'
