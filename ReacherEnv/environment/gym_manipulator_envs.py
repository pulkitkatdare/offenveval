from ReacherEnv.environment.scene_abstract import SingleRobotEmptyScene
from ReacherEnv.environment.env_bases import MJCFBaseBulletEnv
import numpy as np
from ReacherEnv.environment.robot_manipulators import Reacher


class ReacherBulletEnv(MJCFBaseBulletEnv):

  def __init__(self, model_xml = 'reacher.xml', render=False):
    self.robot = Reacher(model_xml=model_xml)
